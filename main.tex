...
\ac{DFFT}	% Akürzung wird ausgeschrieben beim ersten Mal
\ac{DFFT}	% Akürzung wird nicht ausgeschrieben beim zweiten Mal
\acf{DFFT}	% Akürzung wird ausgeschrieben
\acs{DFFT}	% Akürzung wird nicht ausgeschrieben


%
\clearpage
\pagenumbering{Roman}
\setcounter{page}{\numexpr\value{tocpagenumber}+1}
\listoffigures
\listoftables
\printbibliography
